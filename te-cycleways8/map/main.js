...
// (function () {
    ...
    // defaults
    var map_start_location = [37.5253, 127.0322, 16]; // lon/lat for area in San Francisco at zoom 16
    var style_file = 'cycleways.yaml';
    ...
    function createEditLinkElement (url, type, label) {
        ...
        anchor.addEventListener('click', function (event) {
            trackOutboundLink(url, 'editing_cycleway_features', type);
        }, false);
    ...
    */
    ...
    function mapzenTileURL() {
        ...
        var url = 'http://vector.mapzen.com/osm/all/' + zoom + '/' + tileCoords.x  + '/' + tileCoords.y + '.topojson?api_key=vector-tiles-S6vce5W';
        return url;
    }
